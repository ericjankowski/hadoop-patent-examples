...
public class CountYears extends Configured implements Tool{
	...
	public static class ImTheMap extends MapReduceBase implements Mapper<Text, Text, IntWritable, IntWritable> {
		public void map(Text key, Text value, OutputCollector<IntWritable, IntWritable> output, Reporter reporter) throws IOException {
			//Parse the line and make a tick mark for each Year 
	...
	public int run (String [] args) throws Exception {
		...
		JobConf job = new JobConf(conf, CountYears.class);
	...
	public static void main (String [] args) throws Exception {
		int res = ToolRunner.run(new Configuration(),  new CountYears(), args);
		System.exit(res);
	}
}
