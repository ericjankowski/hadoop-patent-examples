...
/*
 * This MapReduce job counts the number of times a particular patent is cited.  It outputs a patent number and the number of times that it is cited from cite75_99
 * 
 */
@SuppressWarnings("deprecation")
public class TimesCited extends Configured implements Tool{
	...
	public int run (String [] args) throws Exception {
		...
		JobConf job = new JobConf(conf, TimesCited.class);
	...
	public static void main (String [] args) throws Exception {
		int res = ToolRunner.run(new Configuration(),  new TimesCited(), args);
		System.exit(res);
	}
}
