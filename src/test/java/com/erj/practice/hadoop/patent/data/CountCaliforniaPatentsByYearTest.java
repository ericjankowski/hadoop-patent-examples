...
public class CountCaliforniaPatentsByYearTest {
	
	CountCaliforniaPatentsByYear.ImTheMap mapper;
	CountCaliforniaPatentsByYear.Reducto reducer;
	Text mapKey;
	Text mapValue;
	...
	@Before
	public void setUp(){
		mapper = new CountCaliforniaPatentsByYear.ImTheMap();
		reducer = new CountCaliforniaPatentsByYear.Reducto();
		mapKey = new Text();
		mapValue = new Text();
	...
	public void mapCollectsOneTickMarkPerRow() throws IOException {
		mapKey.set("3070801,1963,1096,,\"US\",\"CA\",,1,,269,6,69,,1,,0,,,,,,,");
	...
	public void mapShouldNotCollectIfKeyDoesNotContainAPatentNumber() throws IOException {
		mapKey.set("BadDates,1963,1096,,\"US\",\"CA\",,1,,269,6,69,,1,,0,,,,,,,");
	...
	@Test
	public void mapShouldNotCollectIfKeyDoesNotIndicateCalifornia() throws IOException {
