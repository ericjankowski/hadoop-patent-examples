...
public class CountUsStatesTest {
	
	CountUsStates.ImTheMap mapper;
	CountUsStates.Reducto reducer;
	Text key;
	Text value;
	...
	@Before
	public void setUp(){
		mapper = new CountUsStates.ImTheMap();
		reducer = new CountUsStates.Reducto();
		key = new Text();
		value = new Text();
	...
	public void mapCollectsOneTickMarkPerRow() throws IOException {
		key.set("3070801,1963,1096,,\"US\",\"TX\",,1,,269,6,69,,1,,0,,,,,,,");
				
		mapper.map(key, value, output, reporter);
		
		verify(output).collect(eq(new Text("TX")), eq(new IntWritable(1)));
	}
	
	@Test
	public void mapShouldNotCollectIfKeyDoesNotContainAPatentNumber() throws IOException {
		key.set("BadDates,1963,1096,,\"US\",\"TX\",,1,,269,6,69,,1,,0,,,,,,,");
	...
	@Test
	public void mapShouldNotCollectIfCountryIsNotUnitedStates() throws IOException {
		key.set("3070801,1963,1096,,\"BE\",\"TX\",,1,,269,6,69,,1,,0,,,,,,,");
	...
	@Test
	public void mapShouldNotCollectIfNoUsStateIsIndicated() throws IOException {
		key.set("3070801,1963,1096,,\"US\",\"\",,1,,269,6,69,,1,,0,,,,,,,");
